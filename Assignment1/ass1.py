...
def find_peer(filename, hashed,initPort,nextPeer,ogRequestor):
    ...
    if(prevPeer<hashed and testinitPort>=hashed):
        ...
        print("File "+filename+" is here. A response message, destined for"+str(toPrint)+", has been sent")
            ...
            while True:      
                ...
                if(m_type=='F_REQUEST'):
                    if(m_code == 'KEEP'):   #File is here
                        ...
                        print("File "+m_file+" is here. A response message, destined for"+str(m_from)+", has been sent")
                        print("We now start sending the file ..")
